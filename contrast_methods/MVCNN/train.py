...
def main():
    ...
    parser.add_argument('--log_dir', type=str, default=os.path.join(ROOT_DIR, 'Log/MVCNN'))
    parser.add_argument('--checkpoint_dir', type=str, default=os.path.join(ROOT_DIR, 'Checkpoints/MVCNN'))
    ...
    student_model = MVCNNModel()
    teacher_model = MVCNNModel()
