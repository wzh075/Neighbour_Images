...
def main():
    setup_logging()
    parser = argparse.ArgumentParser(description='MoCoV2检索评估脚本')
    ...
    checkpoint_path = args.checkpoint or find_latest_checkpoint(os.path.join(ROOT_DIR, 'Checkpoints/MoCoV2'))
