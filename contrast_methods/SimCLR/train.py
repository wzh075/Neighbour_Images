...
def main():
    ...
    parser.add_argument('--log_dir', type=str, default=os.path.join(ROOT_DIR, 'Log/SimCLR'))
    parser.add_argument('--checkpoint_dir', type=str, default=os.path.join(ROOT_DIR, 'Checkpoints/SimCLR'))
    ...
    logging.info("SimCLR training finished")
