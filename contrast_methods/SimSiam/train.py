...
from contrast_methods.SimSiam.simsiam_model import SimSiamModel
...
def main():
    ...
    parser.add_argument('--log_dir', type=str, default=os.path.join(ROOT_DIR, 'Log/SimSiam'))
    parser.add_argument('--checkpoint_dir', type=str, default=os.path.join(ROOT_DIR, 'Checkpoints/SimSiam'))
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        for batch in tqdm(dataloader, desc=f"Epoch {epoch}"):
            ...
            loss = 0.5 * (negative_cosine_similarity(p1, z2.detach()) + negative_cosine_similarity(p2, z1.detach()))
    ...
    logging.info("SimSiam training finished")
